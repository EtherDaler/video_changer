...
> - torch.compile включается по умолчанию (первый кадр 2–5 мин warm-up, дальше быстрее)
> - для **максимальной скорости** добавь `--fast` (768×768, 15 steps, без IP-Adapter)
...
| `--fast` | — | Максимальная скорость: 768×768, 15 steps, без IP-Adapter (~3–5× быстрее) |
| `--steps` | `30` (20 на Blackwell) | Шаги диффузии (больше = лучше, медленнее) |
